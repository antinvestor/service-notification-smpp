...
require (
	...
	github.com/antinvestor/apis/go/notification v1.55.2
...
require (
	...
	buf.build/gen/go/antinvestor/partition/protocolbuffers/go v1.36.11-20260302135159-869c278b660c.1 // indirect
